...
#$ -o sra10.out             # contains what would normally be printed to stdout (the terminal). As it is, sra.out will print to the current directory.
#$ -e sra10.err             # file name to print standard error messages to. These messages would normally be printed to the the terminal. As it is, sra.err will print to the current directory.
