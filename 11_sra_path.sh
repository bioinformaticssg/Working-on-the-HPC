...
#$ -o /data/users/${USER}/BioinformaticsSG/Working-on-the-HPC/sra_files/sra.out    # contains what would normally be printed to stdout (the terminal)
#$ -e /data/users/${USER}/BioinformaticsSG/Working-on-the-HPC/sra_files/sra.err    # file name to print standard error messages to. These messages would normally be printed to the the terminal
